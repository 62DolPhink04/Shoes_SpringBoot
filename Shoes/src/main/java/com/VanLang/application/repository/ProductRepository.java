package com.VanLang.application.repository;

import com.VanLang.application.model.dto.ChartDTO;
...
//    @Query(value = "SELECT NEW dto.model.com.VanLang.application.ProductInfoDTO(p.id, p.name, p.slug, p.price ,p.images ->> '$[0]', p.total_sold) " +
//            "FROM product p " +
//            "WHERE p.status = 1 " +
